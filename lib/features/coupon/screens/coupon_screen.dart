  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: (ResponsiveHelper.isDesktop(context)
          ...
          : CustomAppBarWidget(
              context: context,
              title: getTranslated('coupon', context))) as PreferredSizeWidget?,
      body: (splashProvider.configModel!.isGuestCheckout! || _isLoggedIn)
          ? Consumer<CouponProvider>(
              builder: (context, coupon, child) {
                List<CouponModel>? couponList = coupon.isActiveSuffixIcon
                    ? coupon.searchedCouponList
                    : coupon.availableCouponList;

                return couponList == null && !coupon.isActiveSuffixIcon
                        ...
                        child: SingleChildScrollView(
                          child: Column(children: [
                            ...
                            if (!ResponsiveHelper.isDesktop(context))
                              BreadcrumbWidget(
                                  items:
                                      BreadcrumbHelper.getCouponBreadcrumb()),
                                        ...
                                        : ResponsiveHelper.isDesktop(context)
                                            ? GridView.builder(
                                                ...
                                                gridDelegate:
                                                  ...
                                                  crossAxisCount:
                                                      3, // Change this value based on desired column count
                                                  mainAxisSpacing: 15,
                                                  crossAxisSpacing: 15,
                                                  childAspectRatio:
                                                      2.8, // Adjust based on desired item shape
                                                ),
      ...
      return SizedBox(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: coupon.isActiveSuffixIcon
                ? IconButton(
                    color: Theme.of(context).hintColor,
                    onPressed: () {
