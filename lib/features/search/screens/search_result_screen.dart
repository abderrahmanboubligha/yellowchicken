...
class _SearchResultScreenState extends State<SearchResultScreen> {
  ...
  void dispose() {
    ...
    Provider.of<SearchProvider>(Get.context!, listen: false)
        .resetFilterData(isUpdate: false);
  }
                      ...
                      Consumer<SearchProvider>(
                        ...
                        return Expanded(
                          ...
                          onSubmit: (value) {
                            ...
                            searchProvider.searchProduct(
                                offset: 1, name: value, context: context);
                          },
                          onSuffixTap: () {
          ...
          if (!isDesktop)
            SliverToBoxAdapter(
              child: BreadcrumbWidget(
                  items: BreadcrumbHelper.getSearchBreadcrumb()),
            ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            searchProvider.searchProductModel != null
                                ? Center(
                                    child: Container(
                                      width: Dimensions.webScreenWidth,
                                      padding: EdgeInsets.only(
                                      ...
                                      child: Row(children: [
                                                ...
                                                : RichText(
                                                    ...
                                                    text: TextSpan(
                                                        ...
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                            text:
                                                                '${searchProvider.searchProductModel?.products?.length} ',
                                                          ...
                                                          TextSpan(
                                                            text:
                                                                '${getTranslated('results_for', context)} ',
                                                            style: rubikRegular.copyWith(
                                                                fontSize: Dimensions
                                                                    .fontSizeSmall,
                                                                color: Theme.of(
                                        ...
                                        const SizedBox(
                                            width:
                                                Dimensions.paddingSizeDefault),
                                        IgnorePointer(
                                          ignoring: searchProvider
                                                  .searchProductModel ==
                                              null,
                                          child: FoodFilterButtonWidget(
                                            type: _type,
                                            items:
                                                productProvider.productTypeList,
                                            isBorder: true,
                                            onSelected: (selected) {
                                              _type = selected;
                                              searchProvider.searchProduct(
