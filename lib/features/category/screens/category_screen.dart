...
class _CategoryScreenState extends State<CategoryScreen>
              ...
              : PaginatedListWidget(
                  ...
                  onPaginate: (int? offset) async {
                    await category.getCategoryProductList(
                        '${category.selectedSubCategoryId}', offset ?? 1,
                        type: _type);
                  },
                    ...
                    slivers: [
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        ...
                                        offset: const Offset(0,
                                            10), // Shift shadow vertically downwards
                                      ),
                                    ],
                                  ),
                                  child: TabBar(
                      ...
                      if (!isDesktop)
                        SliverToBoxAdapter(
                          child: BreadcrumbWidget(
                            items: BreadcrumbHelper.getCategoryBreadcrumb(
                      ...
                      SliverToBoxAdapter(
                        ...
                        onSelected: (selected) {
                          _type = selected;
                          category.getCategoryProductList(
                              category.selectedSubCategoryId, 1,
                              type: _type);
                        },
                      )),
                      ...
                      SliverPadding(
                        ...
                        sliver: category.categoryProductModel == null ||
                                (category.categoryProductModel?.products
                                        ?.isNotEmpty ??
                                    false)
                            ? SliverGrid.builder(
                                gridDelegate:
                                ...
                                itemCount: category.categoryProductModel == null
                                    ? 10
                                    : category
                                        .categoryProductModel!.products!.length,
                                itemBuilder: (context, index) {
                                  ...
                                  return ProductCardWidget(
                                    product: category
                                        .categoryProductModel!.products![index],
                                    imageWidth: 260,
                                  );
                                },
                              )
  ...
  SingleChildScrollView _categoryShimmer(
    ...
    return SingleChildScrollView(
      ...
      ConstrainedBox(
        constraints: BoxConstraints(
            minHeight: !isDesktop && height < 600 ? height : height - 400),
        child: Center(
            child: SizedBox(
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ProductShimmerWidget(
                          isEnabled: category.categoryProductModel == null,
                          isList: false,
                          width: double.maxFinite);
                    },
                  ),
