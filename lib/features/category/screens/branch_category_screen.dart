      ...
      Future.delayed(const Duration(milliseconds: 500)).then((value) {
        if (mounted) {
          showCustomSnackBarHelper(
              getTranslated('branch_successfully_selected', context),
              isError: false);
        }
      });
    }
                      ...
                      child: SearchBar(
                        ...
                        onChanged: (String? value) {
                          categoryProvider.getCategoryProductList(
                              '${categoryProvider.selectedSubCategoryId}', 1,
                        ...
                        hintStyle: WidgetStateProperty.all(rubikRegular
                      ...
                      tabs: [
                        ...
                        Tab(
                            child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                              Image.asset(Images.getImageUrl('veg'),
                        ...
                        Tab(
                            child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                              Image.asset(Images.getImageUrl('non_veg'),
                                  height: IconTheme.of(context).size),
                              const SizedBox(
                                  width: Dimensions.paddingSizeExtraSmall),
...
class QProductList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CategoryProvider>(builder: (context, categoryProvider, _) {
      return categoryProvider.categoryProductModel?.products == null
          ? const Center(child: CircularProgressIndicator())
          : (categoryProvider.categoryProductModel?.products?.isNotEmpty ??
                  false)
              ? GridView.builder(
                  ...
                  itemCount:
                      categoryProvider.categoryProductModel?.products?.length,
