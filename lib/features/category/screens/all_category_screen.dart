...
class _AllCategoryScreenState extends State<AllCategoryScreen>
  ...
  Future<void> _showSearchDialog(
    ...
    if (categoryProvider.suggestionList != null &&
        categoryProvider.suggestionList!.isNotEmpty) {
      await showDialog(
        context: context,
            ...
            child: Material(
              ...
              child: Consumer<CategoryProvider>(
                  builder: (context, categoryProvider, _) => Column(
                        ...
                        children: [
                          SizedBox(
                            width: !isDesktop ? null : 410,
                            height: 50,
                            child: CustomTextFieldWidget(
                              radius: isDesktop ? 50 : Dimensions.radiusSeven,
                              hintText:
                                  getTranslated('search_category', context),
                              isShowBorder: true,
                              fillColor: Theme.of(context).cardColor,
                              isShowPrefixIcon: isDesktop &&
                                  categoryProvider.searchLength == 0,
                              ...
                              onSubmit: (text) async {
                                if (categoryProvider
                                  ...
                                  await categoryProvider.getSearchCategoryList(
                                      offset: 1, query: text);
                          ...
                          categoryProvider.suggestionList != null &&
                                  categoryProvider.suggestionList!.isNotEmpty
                              ? Container(
                                  ...
                                  child: _CategorySearchSuggestionWidget(
                                    queryText:
                                        categoryProvider.searchController.text,
                                  ),
                                )
                              : const SizedBox(),
                        ],
      ...
      return Scaffold(
        appBar: (ResponsiveHelper.isDesktop(context)
            ...
            : CustomAppBarWidget(
                ...
                additionalTitle: categoryProvider.searchCategoryModel != null
                    ? "  (${categoryProvider.searchCategoryModel?.totalSize} ${getTranslated('result_found', context)})  "
                    : null,
        ...
        body: Consumer<CategoryProvider>(
          builder: (context, category, child) {
            return PaginatedListWidget(
              ...
              totalSize: category.searchCategoryModel?.totalSize ??
                  category.categoryModel?.totalSize,
              offset: category.searchCategoryModel?.offset ??
                  category.categoryModel?.offset,
              limit: category.searchCategoryModel?.limit ??
                  category.categoryModel?.limit,
              isDisableWebLoader: !ResponsiveHelper.isDesktop(context),
              builder: (Widget loaderWidget) => Expanded(
                ...
                slivers: [
                          ...
                          children: [
                            isDesktop
                                ? Row(
                                    children: [
                                      Text(
                                          getTranslated("dish_discoveries",
                                                  context) ??
                                              "",
                                    ...
                                    builder: (context, categoryController, _) =>
                                        CustomTextFieldWidget(
                                          ...
                                          hintText: getTranslated(
                                              'search_category', context),
                                          isShowBorder: true,
                                          fillColor:
                                              Theme.of(context).cardColor,
                                          isShowPrefixIcon: isDesktop &&
                                              categoryController.searchLength ==
                                                  0,
                                          prefixIconUrl: Images.search,
                                          prefixIconColor:
                  ...
                  SliverPadding(
                    ...
                    sliver: category.searchCategoryList != null &&
                            category.searchCategoryList!.isEmpty
                        ? const _NoDataWidget()
                        : category.isLoading || category.categoryList != null
                            ? SliverGrid.builder(
                                itemCount:
                                    category.searchCategoryList?.length ??
        ...
        itemBuilder: (context, index) => OnHoverWidget(
          builder: (isHover) {
            return InkWell(
              onTap: () {
                categoryProvider.searchController.text =
                    categoryProvider.suggestionList![index].name ?? "";
                categoryProvider.getSearchCategoryList(
                    offset: 1,
                    query: categoryProvider.suggestionList![index].name ?? "");
                categoryProvider.getSearchText(
                    categoryProvider.suggestionList![index].name ?? "");
                context.pop();
              },
  ...
  TextSpan _highlightText(String source, String query, BuildContext context) {
    ...
    return TextSpan(
      children: [
        ...
        TextSpan(
            text: source.substring(endIndex),
            style: rubikSemiBold.copyWith(
              color: Theme.of(context).hintColor,
              fontSize: Dimensions.fontSizeSmall,
            )),
  ...
  Widget build(BuildContext context) {
    return SliverToBoxAdapter(
      child: Column(children: [
        ...
        Text(
          getTranslated('no_category_found', context)!,
