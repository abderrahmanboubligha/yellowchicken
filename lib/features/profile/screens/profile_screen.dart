                      ...
                      Consumer<AuthProvider>(
                        builder: (context, authProvider, child) {
                          return ProfileTextFieldWidget(
                            ...
                            onValidate: (value) {
                              if(value!.isEmpty){
                                return '${getTranslated('please_enter', context)!} ${getTranslated('email', context)!}';
                              }else if(EmailCheckerHelper.isNotValid(value)){
                        ...
                        child: CustomButtonWidget(
                          ...
                          onTap: () async {
                            ...
                            if(profileFormKey.currentState != null && profileFormKey.currentState!.validate()){
                             ...
                             final bool isNotChanged = profileProvider.userInfoModel?.fName == firstName &&
                             ...
                             final bool isPasswordEmpty = password.isEmpty;
                              ...
                              if (isNotChanged && isPasswordEmpty) {
