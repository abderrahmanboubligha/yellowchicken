...
class OrderSuccessfulWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final OrderProvider orderProvider =
        Provider.of<OrderProvider>(context, listen: false);
    final bool isLoyaltyPointAvailable = widget.status == 0 &&
                  ...
                  children: [
                    ...
                    Column(children: [
                      ...
                      isLoyaltyPointAvailable
                          ? Text(
                              getTranslated(
                                  'your_order_was_placed_successfully',
                                  context)!,
                              style: rubikSemiBold.copyWith(
                                  fontSize: Dimensions.fontSizeLarge),
                            )
                          : widget.status == 0
                              ? Text.rich(
                                  TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            '${getTranslated('was_placed_successfully', context)}'),
                                  ]),
                                  style: rubikSemiBold.copyWith(
                                      fontSize: Dimensions.fontSizeLarge),
                        ...
                        Padding(
                          ...
                          child: Text.rich(
                            TextSpan(children: [
                              ...
                              TextSpan(
                                  text:
                                      '${getTranslated('placed_successfully', context)} ${getTranslated('complete_it_to_earn', context)} $total ${getTranslated('points', context)}, '),
                              TextSpan(
                                  text:
                                      '${getTranslated('which_will_be_added_to_your_wallet', context)}'),
                            ]),
                    ...
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    if ((orderProvider.trackModel?.orderType != 'take_away') &&
                        widget.status == 0)
                      SizedBox(
                    ...
                    InkWell(
                      ...
                      child: Text(getTranslated('back_home', context)!,
                          style: rubikBold),
                    ),
                  ],
                ),
