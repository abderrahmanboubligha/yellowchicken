              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Text(
                      ...
                      style: rubikBold.copyWith(
                        ...
                        fontWeight:
                            isDesktop ? FontWeight.w700 : FontWeight.w600,
                        color: Colors.black,
                      ),
                    ),
                  ),
                  ...
                  ItemViewWidget(
                    ...
                    titleStyle: rubikSemiBold.copyWith(color: Colors.black),
                    subTitleStyle: rubikSemiBold.copyWith(color: Colors.black),
                  ),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  ...
                  if (isDesktop)
                    ItemViewWidget(
                      ...
                      subTitle: PriceConverterHelper.convertPrice(
                        subtotal! + (isTakeAway ? 0 : (deliveryCharge ?? 0)),
                      ),
                      titleStyle: rubikSemiBold.copyWith(color: Colors.black),
                      subTitleStyle: rubikBold.copyWith(color: Colors.black),
                    ),
                ],
              ),
            ),
