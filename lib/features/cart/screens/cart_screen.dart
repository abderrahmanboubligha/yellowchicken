          ...
          return Consumer<CartProvider>(
            builder: (context, cart, child) {
              ...
              for (var cartModel in cart.cartList) {
                ...
                availableList.add(DateConverterHelper.isAvailable(
                ...
                for (int index = 0; index < addOnList.length; index++) {
                  ...
                  addOnsTax = addOnsTax +
                      ((PriceConverterHelper.addonTaxCalculation(
              ...
              double amountAfterDiscount =
                  orderAmount - (discount + couponDiscount);
              ...
              double referralDiscount = CheckOutHelper.getReferralDiscount(
                ...
                referralDetails:
                    profileProvider.userInfoModel?.referralCustomerDetails,
              );

              double total =
                  subTotal - discount - couponDiscount - referralDiscount;

              bool kmWiseCharge = CheckOutHelper.isKmWiseCharge(
                  deliveryInfoModel: splashProvider.deliveryInfoModel);

              bool isFreeDelivery = total >=
                      (splashProvider.deliveryInfoModel?.deliveryChargeSetup
              ...
              return cart.cartList.isNotEmpty
                  ? Column(children: [
                      ...
                      if (!ResponsiveHelper.isDesktop(context))
                        BreadcrumbWidget(
                            items: BreadcrumbHelper.getCartBreadcrumb()),
                                              ...
                                              child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    FrequentlyBoughtWidget(
                                                        scrollController:
                                                            _frequentlyBoughtScrollController),
                                                    const SizedBox(
                                                        height: Dimensions
                                                            .paddingSizeSmall),
                                                  ]),
                                                              ...
                                                              decoration: couponProvider
                                                                  ...
                                                                  ? BoxDecoration(
                                                                      ...
                                                                      border: Border.all(
                                                                          width:
                                                                              1,
                                                                          color: context.customThemeColors.ongoingCardColor.withValues(
                                                                              alpha:
                                                                                  0.15)),
                                                                      borderRadius:
                                                                          BorderRadius.circular(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        ResponsiveHelper.showDialogOrBottomSheet(
                                                                            ...
                                                                            CouponAddWidget(
                                                                                ...
                                                                                amountWithoutTax: amountAfterDiscount));
                                                                      },
                                                                      child:
                                                                          Container(
                                                                        padding: const EdgeInsets
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          color:
                                                                              const Color(0xFFFFF8E1), // Light yellow/cream background
                                                                          boxShadow: [
                                                                            BoxShadow(
                                                                        ...
                                                                        child: Row(
                                                                            children: [
                                                                              const CustomAssetImageWidget(Images.couponIcon, width: Dimensions.paddingSizeLarge, height: Dimensions.paddingSizeLarge, color: Color(0xFFFF8C00)),
                                                          ...
                                                          if (referralDiscount >
                                                            ...
                                                            ItemViewWidget(
                                                              title: getTranslated(
                                                                  ...
                                                                  context)!,
                                                              subTitle:
                                                                  '(-) ${PriceConverterHelper.convertPrice(referralDiscount)}',
                                                            ),
                                                          if (referralDiscount >
                                                              0)
                                                            const SizedBox(
