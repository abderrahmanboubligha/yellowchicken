...
class NotificationScreen extends StatefulWidget {
  ...
  const NotificationScreen({super.key, this.fromSplash = false});
                  ...
                  ? RefreshIndicator(
                      ...
                      child: SingleChildScrollView(
                        ...
                        if (!ResponsiveHelper.isDesktop(context))
                          BreadcrumbWidget(
                              items:
                                  BreadcrumbHelper.getNotificationBreadcrumb()),
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  DateTime originalDateTime =
                                      DateConverterHelper.isoStringToLocalDate(
                                            ...
                                            ? Padding(
                                                padding:
                                                    const EdgeInsets.fromLTRB(
                                                        10, 10, 10, 2),
                                                child: Text(DateConverterHelper
                                            ...
                                            Row(children: [
                                              SizedBox(
                                                  ...
                                                  child: CustomImageWidget(
                                                    image:
                                                        '${splashProvider.baseUrls?.notificationImageUrl}/${notificationProvider.notificationList?[index].image}',
                                                    height: 60,
                                                    width: 60,
                                                    fit: BoxFit.cover,
                                                  )),
