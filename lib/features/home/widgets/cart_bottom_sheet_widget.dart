...
import 'package:flutter_restaurant/common/widgets/product_review_widget.dart';
...
class _CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
  ...
  void initState() {
    ...
    Provider.of<ProductProvider>(context, listen: false).setProductReview =
        null;
    Provider.of<ProductProvider>(context, listen: false)
        .updateProductReviewShowStatus(value: false, isUpdate: false);
    Provider.of<ProductProvider>(context, listen: false)
        .initProductVariationStatus(widget.product!.variations!.length);
    super.initState();
  }
      ...
      return Consumer<CartProvider>(
        builder: (context, cartProvider, child) {
          ({double? price, List<Variation>? variatins}) productBranchWithPrice =
              ProductHelper.getBranchProductVariationWithPrice(widget.product);
          ...
          double discountAmount = (priceWithVariation -
              PriceConverterHelper.convertWithDiscount(
                    ...
                    child: Container(
                      ...
                      child: Consumer<ProductProvider>(
                        builder: (context, productProvider, child) {
                          return productProvider.isShowProductReview
                              ? ProductReviewWidget(
                ...
                : ScrollableBottomSheet(
                    ...
                    child: Container(
                      ...
                      child: Consumer<ProductProvider>(
                        builder: (context, productProvider, child) {
                          return productProvider.isShowProductReview
                              ? ProductReviewWidget(product: widget.product)
                              : cartProductWidget(
                                  context,
                                  price,
                                  priceWithDiscount,
                                    ...
                                    children: [
                                      ...
                                      ListView.builder(
                                        ...
                                        itemBuilder: (context, i) {
                                          double? price = variationList[index]
                                              .variationValues![i]
                                              .optionPrice!;
                                                            ...
                                                            children: [
                                                              variationList[
                                                                  ...
                                                                  ? Checkbox(
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        productProvider
                                                                          ...
                                                                          min: variationList[index]
                                                                              .min,
                                                                          max: variationList[index]
                                                                              .max,
                                                                        );
                                                                      },
                                                                  ...
                                                                  : Radio(
                                                                      ...
                                                                      fillColor: WidgetStateColor.resolveWith((states) => states.contains(WidgetState
                                                                              .selected)
                                                                          ? Theme.of(context)
                                                                              .primaryColor
                                                                          : Theme.of(context)
                            ...
                            child: Row(
                                ...
                                children: [
                                  Expanded(
                                      child: InkWell(
                                    onTap: () {
                                      if (productProvider.addOnQtyList[i]! >
                                          1) {
                                    ...
                                    child: Center(
                                        child: Icon(
                                      productProvider.addOnQtyList[i] == 1
  ...
  Widget _productView(BuildContext context, double price,
      double priceWithDiscount, ProductProvider productProvider) {
    final ConfigModel? configModel =
        Provider.of<SplashProvider>(context, listen: false).configModel;
    final isHalalTagAvailable =
        (widget.product?.branchProduct?.halalStatus == 1) &&
                    ...
                    child: Column(
                      ...
                      Row(children: [
                        ...
                        if (widget.product?.reviewCount != null &&
                          ...
                          InkWell(
                            onTap: () => productProvider
                                .updateProductReviewShowStatus(value: true),
                            child: Row(children: [
                              const Text("( "),
                              Text(
                                "${widget.product?.reviewCount} ${getTranslated("reviews", context)}",
                                style: rubikRegular.copyWith(
                        ...
                        price > priceWithDiscount
                            ? CustomDirectionalityWidget(
                                ...
                                style: rubikRegular.copyWith(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  fontSize:
                                      ResponsiveDimensions.getFontSizeSmall(
                                          context),
                                ),
                                maxLines: 1,
                              ))
                      ...
                      widget.product!.productType != null
                          ? Row(children: [
                              _VegTagView(product: widget.product),
                              if (isHalalTagAvailable)
                                const SizedBox(
                                    width: Dimensions.paddingSizeSmall),
                              if (isHalalTagAvailable)
                                _HalalTagView(product: widget.product),
                            ])
                          : const SizedBox(),
                    ])),
              ])
                  ...
                  Positioned.fill(
                      child: Align(
                          ...
                          child: WishButtonWidget(
                            product: widget.product,
                            edgeInset: const EdgeInsets.only(
...
class _CartProductDescription extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ConfigModel? configModel =
        Provider.of<SplashProvider>(context, listen: false).configModel;
    final isHalalTagAvailable = (product.branchProduct?.halalStatus == 1) &&
        (configModel?.halalTagStatus == 1);
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              product.productType != null && ResponsiveHelper.isMobile()
                  ? Row(children: [
                      ...
                      if (isHalalTagAvailable)
                        const SizedBox(width: Dimensions.paddingSizeSmall),
                      if (isHalalTagAvailable) _HalalTagView(product: product),
                    ])
                  : const SizedBox(),
            ]),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
            Align(
              alignment: localizationProvider.isLtr
                  ? Alignment.topLeft
                  : Alignment.topRight,
              child: ReadMoreText(
                product.description ?? '',
                ...
                style: rubikRegular.copyWith(
                  color: Colors.black,
                  fontSize:
                      ResponsiveDimensions.getProductDescriptionFontSize(),
                ),
                moreStyle: rubikMedium.copyWith(
                  color: Theme.of(context).primaryColor,
                  fontSize: ResponsiveDimensions.getFontSizeSmall(context),
                ),
                lessStyle: rubikMedium.copyWith(
                  color: Theme.of(context).primaryColor,
                  fontSize: ResponsiveDimensions.getFontSizeSmall(context),
                ),
              ),
                ...
                child: Row(children: [
                  Padding(
                      ...
                      child: CustomAssetImageWidget(
                        /// todo - need to change image and need discussion
...
class _HalalTagView extends StatelessWidget {
  final Product? product;
  const _HalalTagView({this.product});
...
class ScrollableBottomSheet extends StatelessWidget {
  ...
  const ScrollableBottomSheet(
      {super.key, required this.child, required this.isDraggableEnable});

  @override
  Widget build(BuildContext context) {
    return !isDraggableEnable
        ? child
        :
