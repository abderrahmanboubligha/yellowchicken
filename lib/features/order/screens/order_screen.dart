  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      Provider.of<OrderProvider>(context, listen: false)
          .getOrderList(context, orderFilter: "ongoing");
      Provider.of<OrderProvider>(context, listen: false)
          .getOrderList(context, orderFilter: "history");
    }
          ...
          ? Consumer<OrderProvider>(
              builder: (context, order, child) {
                return ResponsiveHelper.isDesktop(context)
                    ? const OrderWebWidget()
                    : Column(children: [
                        // Breadcrumb Navigation
                        BreadcrumbWidget(
                            items: BreadcrumbHelper.getOrdersBreadcrumb()),
                                      ...
                                      Expanded(child: Consumer<OrderProvider>(
                                        ...
                                        return TabBarView(
                                          ...
                                          children: [
                                            OrderListWidget(
                                              orderModel:
                                                  orderProvider.ongoingOrder,
                                              filterType: "ongoing",
                                            ),
                                            OrderListWidget(
                                              orderModel:
                                                  orderProvider.historyOrder,
                                              filterType: "history",
                                            ),
                                          ],
                                        );
