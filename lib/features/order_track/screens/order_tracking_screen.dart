...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    final TrackerProvider timerProvider =
      ...
      orderProvider
        ...
        if (orderProvider.trackModel != null && mounted) {
          ...
          if (orderProvider.trackModel?.deliveryMan != null) {
            orderProvider.getDeliveryManData(
                deliverymanId: orderProvider.trackModel?.deliveryMan?.id,
                            ...
                            ResponsiveHelper.isDesktop(context)
                                ...
                                : Column(children: [
                                    CustomStepperWidget(
                                      ...
                                      haveTopBar: false,
                                      statusImage: Images.orderTracking1,
                                      subTitle: orderProvider
                                    ...
                                    CustomStepperWidget(
                                      ...
                                      statusImage: Images.orderTracking2,
                                      subTitle: getTranslated(
                                          'restaurant_confirmed', context),
                                    ),
                                    CustomStepperWidget(
                                      ...
                                      statusImage: Images.orderTracking3,
                                      subTitle: getTranslated(
                                          'food_is_being_prepared', context),
                                    ),
                                    CustomStepperWidget(
                                      title: getTranslated(
                                          'preparing_for_delivery', context),
                                      isComplete:
                                          status == OrderStatus.processing ||
                                              status ==
                                                  OrderStatus.outForDelivery ||
                                              status == OrderStatus.delivered,
                                      statusImage: Images.orderTracking4,
                                      isActive:
                                          status == OrderStatus.processing,
                                      subTitle: getTranslated(
                                          'packing_your_order', context),
                                    ),
                                    Consumer<LocationProvider>(builder:
                                      ...
                                      final bool isOrderActive =
                                          status == OrderStatus.outForDelivery;
                                      final bool isOrderComplete = status ==
                                              OrderStatus.outForDelivery ||
                                          status == OrderStatus.delivered;
                                      ...
                                      return CustomStepperWidget(
                                        ...
                                        isComplete: status ==
                                                OrderStatus.outForDelivery ||
                                            status == OrderStatus.delivered,
                                        statusImage: Images.orderTracking5,
                                        isActive: status ==
                                            OrderStatus.outForDelivery,
                                    ...
                                    CustomStepperWidget(
                                      ...
                                      subTitle: getTranslated(
                                          'order_completed', context),
                                      isComplete:
                                          status == OrderStatus.delivered,
                                      height: orderProvider.deliveryManModel !=
                                                  null &&
                                              configModel?.googleMapStatus == 1
                                          ? 145
                                          : 30,
                                      isActive: status == OrderStatus.delivered,
                                      statusImage: Images.orderTracking6,
                                      child: orderProvider.deliveryManModel !=
                                                  null &&
                                              configModel?.googleMapStatus == 1
                                          ? _trackMapButtonWidget(
