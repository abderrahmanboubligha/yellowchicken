...
import 'package:flutter_restaurant/common/enums/notificaion_type_enum.dart';
...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin{
  ...
  void notificationRoute() {
    NotificationType? notificationTypeEnum = getNotificationTypeEnum(notificationType);

    switch(notificationTypeEnum){
      case NotificationType.order:
        RouterHelper.getOrderDetailsRoute(payloadModel?.orderId, fromSplash: true, action: RouteAction.pushNamedAndRemoveUntil);
        break;
      case NotificationType.message:
        RouterHelper.getChatRoute(fromSplash: true, action: RouteAction.pushNamedAndRemoveUntil);
        break;
      case NotificationType.general:
        RouterHelper.getNotificationRoute(fromSplash: true, action: RouteAction.pushNamedAndRemoveUntil);
        break;
      case null:
        debugPrint('================Notification type does not exist=================$notificationType');
        RouterHelper.getMainRoute(action: RouteAction.pushNamedAndRemoveUntil);
      case NotificationType.referral:
        RouterHelper.getWalletRoute(action: RouteAction.pushNamedAndRemoveUntil);
    }
  }
