    ...
    return Scaffold(
        appBar: (ResponsiveHelper.isDesktop(context)
            ...
            : CustomAppBarWidget(
                ...
                centerTitle: true)) as PreferredSizeWidget?,
            ...
            ? Padding(
                ...
                child: !ResponsiveHelper.isDesktop(context)
                    ? FloatingActionButton(
                        ...
                        onPressed: () => RouterHelper.getAddAddressRoute(
                            page: 'address',
                            action: 'add',
        ...
        body: CustomScrollView(
          slivers: [
            ...
            if (_isLoggedIn && !ResponsiveHelper.isDesktop(context))
              SliverToBoxAdapter(
                child: BreadcrumbWidget(
                    items: BreadcrumbHelper.getAddressBreadcrumb()),
              ),
                      ...
                      builder: (context, locationProvider, child) {
                        return RefreshIndicator(
                          ...
                          child: ResponsiveHelper.isDesktop(context)
                              ...
                              : CustomPaint(
                                  size: const Size(
                                      Dimensions.webScreenWidth, 150),
                                  painter: locationProvider.addressList ==
                                              null ||
