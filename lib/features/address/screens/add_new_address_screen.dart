...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  _initLoading() async {
    ...
    locationProvider.onChangeSaveAddressStatus(!widget.isCurrentLocation,
        isUpdate: false);
                              ...
                              child: Column(children: [
                                ...
                                if (!ResponsiveHelper.isDesktop(context) &&
                                  ...
                                  Row(children: [
                                    ...
                                    Text(
                                      getTranslated(
                                          'also_save_in_my_profile', context)!,
                    ...
                    child: Column(children: [
                      locationProvider.addressStatusMessage != null
                          ? Row(
                              ...
                              children: [
                                  locationProvider
                                          .addressStatusMessage!.isNotEmpty
                                      ? const CircleAvatar(
  ...
  Future<void> _saveAddress(LocationProvider locationProvider) async {
    ...
    if (addressFormKey.currentState != null &&
      ...
      bool isAvailable =
          branches.length == 1 && (branches[0]!.latitude == null);
      if (!isAvailable) {
      ...
      if (!isAvailable && configModel.googleMapStatus == 1) {
        showCustomSnackBarHelper(getTranslated(
            _isAddressNotFetched(locationProvider.position)
                ? 'please_select_your_address_from_map'
                ...
                if (widget.fromCheckout) {
                  if (widget.routeType == RouteTypeEnum.appbar) {
                    locationProvider.onChangeCurrentAddress(
                        locationProvider.addressList?.first,
                        isUpdate: true);
                  } else {
  ...
  bool _isAddressNotFetched(Position position) =>
